 ...
 * Main.java
 * 
 *  This class takes a CSV file and parses it into a SQLite in memory databse
 * 
 * 
 * 
 * @author Todd Weber
...
class Main {
	...
	private static final String SQL = "INSERT INTO interviewData(A,B,C,D,E,F,G,H,I,j) VALUES(?,?,?,?,?,?,?,?,?,?)";
	private static final String SQL_CREATE = "CREATE TABLE interviewData"
            + "("
            + " A string,"
            + " B string,"
            + " C string,"
	...
	public static void main(String args[]) 
	{
		...
		//Creating the Frame
        JFrame frame = new JFrame("CSV Parser");
        ...
        button.addActionListener(new ActionListener () { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		//we initialize columnNumber at 1 because it makes logical sense
	...
	//this helper method write a line to a file
